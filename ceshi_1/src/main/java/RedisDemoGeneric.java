...
//        params.nx();
    ...
    public static void main(String[] args) {
        // 连接到 Redis 服务器上 (通过 Jedis 这个库与 Redis 建立连接)
        // JedisPool 是 Redis 连接池
        JedisPool jedisPool = new JedisPool("tcp://127.0.0.1:8888");

        // 从 redis 连接池中取一个连接出来，连接用完之后记得释放（close）
        // 此处的释放，不一定是真的关闭 tcp 连接，而是放回到池子里
