...
public class RedisDemoZSet {
    ...
    public static void test1(Jedis jedis) {
        ...
        System.out.println("memberWithScore:" + membersWithScore);
        // 单独对某个元素进行操作
    ...
    public static void test4(Jedis jedis) {
        ...
        Double score1 = jedis.zscore("key", "zhangsan2");
        System.out.println("score1:" + score1);

        Double score2 = jedis.zscore("key", "zhangsan");
    ...
    public static void test5(Jedis jedis) {
        ...
        Long rank1 = jedis.zrank("key", "zhangsan2");
        System.out.println("rank1:" + rank1);

        Long rank2 = jedis.zrank("key", "wangwu");
